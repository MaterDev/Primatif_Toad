...
We moved all existing project folders into `source/` to keep the root clean for scripts and configuration. We initialized a Git repository that ignores the contents of `source/` but tracks our admin tools.
