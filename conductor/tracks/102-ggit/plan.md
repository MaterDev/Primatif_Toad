...
> **Source of Truth:** `docs/releases/v1.0.2/tasks.md` § Phase 5.
...
- [ ] **P5-8: `toad ggit` Command** (`bin/toad`, MIT)
  - Full CLI surface: status, branch, checkout, add, commit, push, pull,
    sync, log, diff, branches, merge-status, align, preflight.
