...
## Overview
Transform Toad into a live context oracle that AI agents can query directly via the Model Context Protocol.
...
2. Expose core tools: `list_projects`, `get_project_detail`, `search_projects`, `get_ecosystem_summary`.
