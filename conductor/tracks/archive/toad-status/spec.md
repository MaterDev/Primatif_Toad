...
4. **UX Optimization:**
   - **Summary View:** If a project is clean, compress it into a summary count
     (e.g., "70/72 Clean").
   - **Dirty Promotion:** Display detailed status ONLY for projects with
     changes.
   - **Sorting:** Sort "Dirty" projects by modification time (most recent
     first).
