...
> **Source of Truth:** `docs/releases/v1.0.2/tasks.md` § Phase 1, Phase 2,
> Phase 3. This plan is an execution guide. The release docs are authoritative.
...
- [ ] **P2-4: Convert to Submodules**
  ...
  - **Version pinning:** Verify each submodule entry references the SHA from the
    newly pushed `main` branch. `git submodule status` must show all submodules
    pointing to valid, reachable remote commits.
