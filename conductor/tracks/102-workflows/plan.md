...
> **Source of Truth:** `docs/releases/v1.0.2/tasks.md` § Phase 7. This plan is
...
- [ ] **P7-1: Workflow Registry** (`toad-core`, MIT)
  ...
  - `reserved_namespaces` field is a cache — authoritative list is in
    `toad-ops`.

## Phase 2: Namespace Authority & Execution

- [ ] **P7-2: Reserved Namespace Authority** (`toad-ops`, BUSL-1.1)
  - Add `reserved_command_names() -> Vec<&'static str>` — single source of
    truth.
