# Spec: Bulk Operation Safety (Guardrails)
...
3. **High-Bar Confirmation:** Require specific user input (e.g., typing `YES` or
   the target count) when destructive patterns are found.
4. **Process Isolation & Limits:**
