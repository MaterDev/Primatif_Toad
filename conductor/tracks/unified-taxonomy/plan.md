...
- [ ] **Phase 1: Core Model Refactor**
  - [ ] Update `ProjectDetail` in `toad-core` (Replace stack/hashtags with
        taxonomy).
...
- [ ] **Phase 2: Exhaustive Discovery**
  ...
  - [ ] Update `scan_all_projects` to build the exhaustive taxonomy (Detected
...
- [ ] **Verification**
  - [ ] Run `toad manifest` on a hybrid (Rust+Node) project and verify both tags
        appear.
  - [ ] Perform SemVer bump.
- [ ] **Release v1.0.0 (RC)**
