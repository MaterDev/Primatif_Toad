...
If you want to run a quick test without leaving any files behind, use the
`run_ephemeral.sh` utility. It creates a temp directory, populates it, runs your
command, and then nukes everything automatically.
